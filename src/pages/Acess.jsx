...
const Acess = () => {
  ...
  useEffect(() => {
    let filteredAccessories = products.filter((item) => item.accessories === true); // Filter men products
    ...
    if (sortOption === 'latest') {
      filteredAccessories.sort((a, b) => b.date - a.date); // Sort by latest
    } else if (sortOption === 'oldest') {
      filteredAccessories.sort((a, b) => a.date - b.date); // Sort by oldest
    } else if (sortOption === 'price-low') {
      filteredAccessories.sort((a, b) => a.price - b.price); // Sort by price (low to high)
    } else if (sortOption === 'price-high') {
      filteredAccessories.sort((a, b) => b.price - a.price); // Sort by price (high to low)
    }
